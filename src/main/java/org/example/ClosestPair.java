...
public class ClosestPair {
    ...
    public static double closest(Point2D.Double[] points, Metrics m) {
        ...
        return closestRec(px, py, m);
    }

    private static double closestRec(Point2D.Double[] px, Point2D.Double[] py, Metrics m) {
        int n = px.length;
        ...
        double dl = closestRec(Qx, Qy, m);
        double dr = closestRec(Rx, Ry, m);
